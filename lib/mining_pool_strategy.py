...
class MiningPoolStrategy:
    ...
    def make_decision(
        ...
        v27_profit = self.calculate_pool_profitability(pool, 'v27', price_oracle, fee_oracle)
        v26_profit = self.calculate_pool_profitability(pool, 'v26', price_oracle, fee_oracle)
        ...
        if pool.fork_preference != ForkPreference.NEUTRAL:
            ...
            if preferred_fork != rational_choice:
                ...
                if can_afford_ideology:
                    ...
                    reason = f"Ideology: supporting {preferred_fork} despite {loss_pct*100:.1f}% lower profit"
